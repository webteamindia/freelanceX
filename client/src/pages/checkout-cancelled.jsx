...
export default function CheckoutCancelledPage() {
  ...
  return (
    <div className="h-[80vh] flex items-center px-6 md:px-20 pt-20 flex-col text-center">
      <h1 className="text-2xl md:text-4xl font-semibold">Payment was cancelled</h1>
      <p className="text-zinc-400 mt-4 max-w-2xl">
        Your order has not been completed yet. You can return to checkout and pay when ready.
      </p>
      {orderID ? (
